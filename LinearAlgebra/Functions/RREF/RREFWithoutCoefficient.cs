...
{
    public static Result RREF(Fraction[,] matrix, bool solution = false, CancellationToken token = default)
    {
    ...
    private static void ClearPivotRow(Fraction[,] matrix, int pivotRow, int pivotColumn, List<MatrixStep>? solution)
    {
